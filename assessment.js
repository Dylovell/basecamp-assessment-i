...
// CODE HERE
var trueFaveNum = 13;
  trueFaveNum = faveNum ==13 ? true:false;
...
var responseCreator = function(param){
  // CODE HERE
  if (param == "green") {
    this.colorResponse = "Green is okay";
  } else if (param == "red") { 
    this.colorResponse = "I heart red";
  } else {
    this.colorResponse = "What is your favorite color?";
  }
...
function greeter(nam,num) {
  return "Hi! I am "+nam+" and I am "+num+" years old";
};
greeter(name,number);
